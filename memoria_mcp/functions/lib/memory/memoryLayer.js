...
class SimplifiedMemoryLayer {
    constructor(weaviateUrl, apiKey) {
        this.client = null;
        this.className = 'ConversationMemory';
    ...
    async retrieveContext(userInput, limit = 5, filters) {
        ...
        try {
            ...
            const recentConversations = memories.map((m) => {
                var _a;
                return ({
                    id: ((_a = m._additional) === null || _a === void 0 ? void 0 : _a.id) || (0, uuid_1.v4)(),
        ...
        try {
            ...
            return {
                ...
                memories: memories.map((m) => {
                    var _a;
                    return ({
                        id: (_a = m._additional) === null || _a === void 0 ? void 0 : _a.id,
                        userInput: m.userInput,
                        response: m.response,
                        concepts: m.concepts || [],
                        timestamp: m.timestamp,
        ...
        try {
            ...
            return memories.map((m) => {
                ...
                return ({
                    ...
                    episodeId: m.episodeId,
                    userId: m.userId,
                    certainty: (_b = m._additional) === null || _b === void 0 ? void 0 : _b.certainty,
                });
            });
        }
        catch (error) {
        ...
        try {
            ...
            return {
                ...
                averageConceptsPerMemory: memories.length > 0
                    ? memories.reduce((sum, m) => { var _a; return sum + (((_a = m.concepts) === null || _a === void 0 ? void 0 : _a.length) || 0); }, 0) / memories.length
                    : 0,
            };
        }
        catch (error) {
